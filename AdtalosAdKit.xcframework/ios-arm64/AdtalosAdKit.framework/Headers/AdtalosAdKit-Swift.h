...
#ifndef ADTALOSADKIT_SWIFT_H
#define ADTALOSADKIT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdtalosAdKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
- (BOOL)sendLossNotice:(enum AdtalosLossReason)lossReason;
...
@interface AdtalosViewAd : AdtalosBaseAd
...
@interface AdtalosBannerAd : AdtalosViewAd
...
@interface AdtalosFeedAd : AdtalosViewAd
...
@interface AdtalosViewControllerAd : AdtalosViewAd
...
typedef SWIFT_ENUM_NAMED(NSInteger, AdtalosLossReason, "LossReason", open) {
  AdtalosLossReasonBidPriceFilter = 1001,
  AdtalosLossReasonPriceLowFilter = 1002,
  AdtalosLossReasonAdmBlacklistFilter = 1003,
  AdtalosLossReasonCompleteFilter = 1004,
  AdtalosLossReasonTimeoutFilter = 1005,
...
@interface AdtalosNativeAdView : UIView
@property (nonatomic, readonly) CGSize intrinsicContentSize;
/// 使用给定的 <code>NativeAd</code> 渲染原生模板广告（公开接口）。
- (void)renderWithAd:(AdtalosNativeAd * _Nonnull)ad;
- (void)layoutSubviews;
/// 销毁广告视图，释放所有内部资源。
...
@interface AdtalosNativeAdView (SWIFT_EXTENSION(AdtalosAdKit))
...
+ (void)initialize:(AdtalosConfiguration * _Nonnull)config;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS_NAMED("SplashAd")
@interface AdtalosSplashAd : AdtalosViewControllerAd
- (nonnull instancetype)initWithUnitID:(NSString * _Nonnull)unitID OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, readonly, strong) AdtalosVideoMetadata * _Nullable metadata;
@property (nonatomic, readonly) BOOL hasVideo;
- (void)play;
- (void)pause;
- (void)mute:(BOOL)mute;
...
@optional
- (void)onVideoLoad:(AdtalosVideoMetadata * _Nonnull)metadata;
- (void)onVideoStart;
- (void)onVideoPlay;
- (void)onVideoPause;
- (void)onVideoEnd;
...
enum AdtalosPlayType : NSInteger;
enum AdtalosStatus : NSInteger;
@class NSData;
SWIFT_CLASS_NAMED("VideoMetadata")
@interface AdtalosVideoMetadata : NSObject
...
@property (nonatomic) enum AdtalosPlayType type;
@property (nonatomic) enum AdtalosStatus status;
...
typedef SWIFT_ENUM_NAMED(NSInteger, AdtalosPlayType, "PlayType", open) {
  AdtalosPlayTypeFirstPlay = 1,
  AdtalosPlayTypeContinuePlay = 2,
  AdtalosPlayTypeReplay = 3,
};

typedef SWIFT_ENUM_NAMED(NSInteger, AdtalosStatus, "Status", open) {
  AdtalosStatusNormal = 0,
  AdtalosStatusLoading = 1,
  AdtalosStatusError = 2,
};
